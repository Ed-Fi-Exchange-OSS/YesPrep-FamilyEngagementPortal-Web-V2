...
namespace Student1.ParentPortal.Resources.Services.Students
{
    ...
    public class StudentAttendanceService : IStudentAttendanceService
    {
        ...
        public async Task<StudentAttendance> GetStudentAttendanceAsync(int studentUsi)
        {
            ...
            //We considerate only the excused absents and unexcused absents 
            List<StudentAttendanceEvent> abscentEvents = new List<StudentAttendanceEvent>();
            abscentEvents.AddRange(excusedEvents);
            abscentEvents.AddRange(unexcusedEvents);
