...
insert into edfi.StaffElectronicMail(ElectronicMailTypeDescriptorId, StaffUSI, ElectronicMailAddress,CreateDate)
values(818, 49, 'fred.lloyd@toolwise.onmicrosoft.com',GETDATE());
...
-- Adding Messages
insert into ParentPortal.ChatLog(StudentUniqueId, SenderTypeId, SenderUniqueId, RecipientTypeId, RecipientUniqueId,EnglishMessage, OriginalMessage, DateSent, RecipientHasRead)
values(605541, 2, 207260, 1, 777779, 'Message for Demo', 'Message for Demo', GETDATE(), 0);

insert into ParentPortal.ChatLog(StudentUniqueId, SenderTypeId, SenderUniqueId, RecipientTypeId, RecipientUniqueId,EnglishMessage, OriginalMessage, DateSent, RecipientHasRead)
values(605255, 2, 207272, 1, 777779, 'Hello','Hello', GETDATE(), 0);
insert into ParentPortal.ChatLog(StudentUniqueId, SenderTypeId, SenderUniqueId, RecipientTypeId, RecipientUniqueId, EnglishMessage,OriginalMessage, DateSent, RecipientHasRead)
values(605255, 2, 207272, 1, 777779, 'This is a message','This is a message', GETDATE(), 0);
GO
