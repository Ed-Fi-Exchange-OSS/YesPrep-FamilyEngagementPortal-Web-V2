...
namespace Student1.ParentPortal.Data.Models.EdFi25
{
    public class CommunicationsRepository : ICommunicationsRepository
    {
        ...
        public async Task<List<ParentStudentsModel>> GetParentsByGradeLevelsAndPrograms(Guid queueId, int staffUsi, int[] grades, int[] programs, string[] validParentDescriptors, string[] validEmailTypeDescriptors,  DateTime endOfDayTodayWithPadding, DateTime beginningOfDayTodayWithPadding)
        {
            //Here we got the information for the school first 
        ...
        public async Task<List<StudentBriefModel>> GetStudentListByGradeLevelsAndSearchTerm( string term, GradesLevelModel model, string[] validParentDescriptors,  DateTime endOfDayTodayWithPadding, DateTime beginningOfDayTodayWithPadding, int schoolId)
        {
            return null;
        }
        ...
        public Task<List<StudentBriefModel>> GetStudentListByGradeLevelsProgramsAndSearchTerm(string searchTerm, GradesLevelModel model, string[] validParentDescriptors, DateTime endOfDayTodayWithPadding, DateTime beginningOfDayTodayWithPadding, int schoolId, int[] programs)
        {
            throw new NotImplementedException();
        }

        public Task<ChatLogItemModel> EnsureGroupMessageChatLog(Guid groupMessageQueueId, ChatLogItemModel model)
        {
            throw new NotImplementedException("Not implemented in Ed-Fi 2.x.");
        }

        Task<List<UnreadDirectMessageAdvisoryModel>> ICommunicationsRepository.GetUnAdvisedChatLogs(string[] validEmailTypeDescriptors, string[] validMobileTelephoneNumberTypeDescriptors)
        {
            throw new NotImplementedException("Not implemented for Ed-Fi 2.x.");
        }

        Task ICommunicationsRepository.WriteMessageAdvisoryLog(Guid chatLogId, string advisoryTypeSent, string errorMessage)
        {
            throw new NotImplementedException("Not implemented for Ed-Fi 2.x.");
        }

        Task<bool> ICommunicationsRepository.ChatLogAdvisoryExists(Guid chatLogId)
        {
            throw new NotImplementedException("Not implemented for Ed-Fi 2.x.");
        }
    }
