...
namespace Student1.ParentPortal.Data.Models.EdFi25
{
    public class TeacherRepository : ITeacherRepository
    {
        ...
        public async Task<List<StaffSectionModel>> GetStaffSectionsAsync(int staffUsi,DateTime beginningOfPaddingFromToday, DateTime endOfPaddingFromToday, DateTime beginningOfDayToday, DateTime endOfDayToday)
        {
        ...
        public async Task<List<StudentBriefModel>> GetTeacherStudents(int staffUsi, TeacherStudentsRequestModel model, string recipientUniqueId, int recipientTypeId, DateTime beginingOfDaytoday, DateTime endOfDaytoday)
        {
