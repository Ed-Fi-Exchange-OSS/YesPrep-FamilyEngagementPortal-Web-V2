...
namespace Student1.ParentPortal.Data.Models
{
    ...
    {
        Task<List<StaffSectionModel>> GetStaffSectionsAsync(int staffUsi, DateTime beginningOfPaddingFromToday, DateTime endOfPaddingFromToday, DateTime beginningOfDayToday, DateTime endOfDayToday);
        Task<List<StudentBriefModel>> GetTeacherStudents(int staffUsi, TeacherStudentsRequestModel model, string recipientUniqueId, int recipientTypeId, DateTime beginningOfPaddingFromToday, DateTime endOfPaddingFromToday);
