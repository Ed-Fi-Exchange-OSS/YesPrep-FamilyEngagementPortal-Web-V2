...
namespace Student1.ParentPortal.Web.Security
{
    public class AuthorizationFilterAttribute : ActionFilterAttribute
    {
        ...
        public override void OnActionExecuting(HttpActionContext actionContext)
        {
            ...
            if (isDemoUserAuthentication(actionContext))
                return;
        ...
        private bool isDemoUserAuthentication(HttpActionContext actionContext) 
        {
            return actionContext.ActionDescriptor.ActionName == "GetUserDemoForApple";
        }
    }
}