    ...
    .component('navbar', {
        ...
        controller: ['adalAuthenticationService', 'landingRouteService', 'api', '$window', '$translate', '$location', '$rootScope', 'impersonateService', '$state', 'communicationService',
            function (adalService, landingRouteService, api, $window, $translate, $location, $rootScope, impersonateService, $state, communicationService) {
                ...
                ctrl.showReports = false;
                ctrl.showReportsPersonType = false;
                ...
                api.me.getRole().then(function (role) {
                    ...
                    api.customParams.getAll().then(function (parameters) {
                        ctrl.showReports = parameters.showReports;
                        switch (role) {
                            case "Admin":
                                ctrl.showReportsPersonType = parameters.showReportsAdmin;
                                break;
                            case "CampusLeader":
                                ctrl.showReportsPersonType = parameters.showReportsCL;
                                break;
                            case "Staff":
                                ctrl.showReportsPersonType = parameters.showReportsTeacher;
                                break;
