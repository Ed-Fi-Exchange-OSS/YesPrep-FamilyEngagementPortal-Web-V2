angular.module('app')
    ...
    .config(['$stateProvider', function($stateProvider) {
        $stateProvider.state('app.studentdetail', {
            url: '/studentdetail/:studentId/:?anchor?showCIC',
                views: {
                ...
                resolve: {
                    ...
                    person: ['api', function (api) {
                        return api.me.getMyBriefProfile();
                    }],
                    showCIC: ['$stateParams', function ($stateParams) {
                        return $stateParams.showCIC || false;
                    }],
                }
            });
    }])
        ...
        controller: ['api', '$anchorScroll', '$location', 'landingRouteService', '$translate', '$rootScope', 'appConfig',
            ...
            ctrl.$onInit = function () {
                ...
                api.students.getStudentCourseGrades(ctrl.currentStudent).then(function (data) {
                    ...
                    ctrl.model.courseGrades.person = ctrl.person;
                });
                ...
                api.students.getStudentStaarAssessmentHistory(ctrl.currentStudent).then(function (data) {
                    if (data) {
                        ctrl.model.staarAssessmentHistory = data;
                    }
                    ctrl.model.staarAssessmentHistory = data;
                });

                ctrl.heroTextDesc = ctrl.person.role == "Staff" ? $translate.instant('view.disciplineIncidents.moreDetail.staff'): $translate.instant('view.disciplineIncidents.moreDetail');
