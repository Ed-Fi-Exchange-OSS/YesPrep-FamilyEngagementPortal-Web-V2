    ...
    .component('communications', {
        ...
        controller: ['api', '$translate', '$timeout', '$rootScope', 'landingRouteService', 'signalRService', '$location', 'unreadMessagesServices',
            function (api, $translate, $timeout, $rootScope, landingRouteService, signalRService, $location, unreadMessagesServices) {
                ...
                ctrl.splitMessage = function (message, nb) {
                    var array = message.split('data:');
                    return array[nb];
                }
                ...
                // Send message
                ctrl.sendMessage = function (image) {
                    ...
                    var chatModel = {
                        ...
                        englishMessage: ctrl.model.message ? ctrl.model.message:image,
                ...
                ctrl.sendImage = function () {
                    ...
                    reader.onload = function () {
                        ctrl.sendMessage(reader.result);
                    }
