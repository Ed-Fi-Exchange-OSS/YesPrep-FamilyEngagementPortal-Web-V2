angular.module('app.languages', [])
    ...
    .constant('availableLanguages',
        { languages: [
            ...
            { id: 'kmr-iq', language: 'Kurdish (Northern)', flag: 'iq', lang: 'kmr', variant: null },
            { id: 'ku-iq', language: 'Kurdish (Central)', flag: 'iq', lang: 'ku', variant: null },
            { id: 'or-in', language: 'Odia', flag: 'in', lang: 'or', variant: null },
            { id: 'pl-pl', language: 'Polski', flag: 'pl', lang: 'pl', variant: null },
            { id: 'prs-af', language: 'Dari', flag: 'af', lang: 'prs', variant: null },
            { id: 'ps-af', language: 'Pashto', flag: 'af', lang: 'ps', variant: null },
        ]}
    );
